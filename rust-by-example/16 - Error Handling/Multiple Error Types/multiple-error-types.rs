...
// Using our knowledge of combinators, we can rewrite the above to explicitly handle errors.
// Since two different types of errors can occur, we need to convert them to a common type
// such as a String.

// To do so, we convert both the Option and Result into Results, and then map their errors to
// the same type:
