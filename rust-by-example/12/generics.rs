...
// type parameter <T>. Any type specified as a generic type parameter is generic,
// and everything else is concrete (non-generic).

// Example: defining a generic function named foo that takes an argument T of any type:
