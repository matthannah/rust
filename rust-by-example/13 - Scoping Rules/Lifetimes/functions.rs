// Ignoring 'elision', function signatures with lifetimes have a few contraints:

// any reference must have an annotated lifetime
// any reference being returned must have the same lifetime as an input or be static

// Additionally, note that returning references without proper input is banned if it
