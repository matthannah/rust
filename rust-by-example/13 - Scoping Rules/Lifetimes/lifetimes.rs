// A lifetime is a contruct the compiler (also called the borrow checker) uses to
// ensure all borrows are valid. Specifically, a variable's lifetime begins when it
// is created and ends when it is destroyed. While lifetimes and scopes are often
