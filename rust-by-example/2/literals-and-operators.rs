...
// binary notation using either of these prefixes: 0x, 0o, 0b
...
// 32 bit integer, and the i32 suffix to indicate the literal is a
// signed 32 bit integer

// Operators available and their precedence in rust are similar to C-like
// languages
